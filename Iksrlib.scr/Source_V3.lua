	...
	function TabFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddDropdown(DropdownConfig)
				...
				local TitleLabel = AddThemeObject(SetProps(MakeElement("Label", DropdownConfig.Name, 16), {
					Size = UDim2.new(1, -12, 1, 0),
					Position = UDim2.new(0, 12, 0, 0),
					Font = Enum.Font.GothamBold,
					Name = "Title"
				...
				-- 選択中の内容表示（小型化・初期は非表示）
				local SelectedContentLabel = AddThemeObject(SetProps(MakeElement("Label", "", 12), {
				...
				local function AddOptions(OptionTable)
					for key, Option in pairs(OptionTable) do
						local OptionBtn = AddThemeObject(SetProps(SetChildren(MakeElement("Button", Color3.fromRGB(40, 40, 40)), {
							...
							-- タイトル
							AddThemeObject(SetProps(MakeElement("Label", Option.Title or key, 15, 0.2), {
							...
							-- 下部説明
							AddThemeObject(SetProps(MakeElement("Label", Option.Contents or Option.ContentS or "", 11, 0.4), {
				...
				AddConnection(Click.MouseButton1Click, function()
					...
					if count > MaxElements then
						TweenService:Create(DropdownFrame,TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = Dropdown.Toggled and UDim2.new(1, 0, 0, 38 + (MaxElements * 36)) or UDim2.new(1, 0, 0, 38)}):Play()
					else
