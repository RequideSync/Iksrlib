	...
	function TabFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddDropdown(DropdownConfig)
				...
				local TitleLabel = AddThemeObject(SetProps(MakeElement("Label", DropdownConfig.Name, 20), {
					Size = UDim2.new(1, -12, 1, 0),
					Position = UDim2.new(0, 12, 0, 0),
					Font = Enum.Font.GothamBlack,
					Name = "Title"
				...
				local function AddOptions(OptionTable)
					for key, Option in pairs(OptionTable) do
						local OptionBtn = AddThemeObject(SetProps(SetChildren(MakeElement("Button", Color3.fromRGB(40, 40, 40)), {
							...
							-- タイトル（大きく）
							AddThemeObject(SetProps(MakeElement("Label", Option.Title or key, 22, 0.1), {
							...
							-- 下部説明（大きく）
							AddThemeObject(SetProps(MakeElement("Label", Option.Contents or Option.ContentS or "", 16, 0.2), {
				...
				AddConnection(Click.MouseButton1Click, function()
					...
					if count > MaxElements then
						TweenService:Create(DropdownFrame,TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = Dropdown.Toggled and UDim2.new(1, 0, 0, 48 + (MaxElements * 72)) or UDim2.new(1, 0, 0, 48)}):Play()
					else
						TweenService:Create(DropdownFrame,TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = Dropdown.Toggled and UDim2.new(1, 0, 0, DropdownList.AbsoluteContentSize.Y + 48) or UDim2.new(1, 0, 0, 48)}):Play()
					end
				end)
