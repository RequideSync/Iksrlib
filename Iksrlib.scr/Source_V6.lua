	...
	function TabFunction:MakeTab(TabConfig)
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddDropdown(DropdownConfig)
				...
				local TitleLabel = AddThemeObject(SetProps(MakeElement("Label", DropdownConfig.Name, 17), {
					Size = UDim2.new(1, -12, 1, 0),
					Position = UDim2.new(0, 12, 0, 0),
					Font = Enum.Font.GothamBlack,
					Name = "Title"
				...
				local DropdownFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
					...
					SetProps(SetChildren(MakeElement("TFrame"), {
						...
						AddThemeObject(SetProps(MakeElement("Label", "", 15), {
				...
				local function AddOptions(OptionTable)
					for key, Option in pairs(OptionTable) do
						local OptionBtn = AddThemeObject(SetProps(SetChildren(MakeElement("Button", Color3.fromRGB(40, 40, 40)), {
							...
							-- タイトル（少し小さめ・見やすく）
							AddThemeObject(SetProps(MakeElement("Label", Option.Title or key, 17, 0.05), {
							...
							-- タイトルと説明の間にDivider
							AddThemeObject(SetProps(MakeElement("Frame", Color3.fromRGB(60, 60, 60)), {
							...
							-- 下部説明（少し小さめ・見やすく）
							AddThemeObject(SetProps(MakeElement("Label", Option.Contents or Option.ContentS or "", 13, 0.15), {
				...
				function Dropdown:Set(Value)
					if not Dropdown.Option[Value] then
						...
						DropdownFrame.F.Selected.Font = Enum.Font.GothamBlack
						for _, v in pairs(Dropdown.Buttons) do
							TweenService:Create(v,TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{BackgroundTransparency = 1}):Play()
							TweenService:Create(v.Title,TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{TextTransparency = 0.05}):Play()
						end	
						return
					end
				...
				AddConnection(Click.MouseButton1Click, function()
					...
					if count > MaxElements then
						TweenService:Create(DropdownFrame,TweenInfo.new(.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = Dropdown.Toggled and UDim2.new(1, 0, 0, 38 + (MaxElements * 44)) or UDim2.new(1, 0, 0, 38)}):Play()
					else
